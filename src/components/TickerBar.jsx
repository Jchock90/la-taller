...
const TickerBar = () => {
  ...
  return (
    <div className="w-full flex items-center overflow-hidden bg-black win-ridge" style={{ minHeight: 0, height: '18px' }}>
      <div className="relative w-full">
        <span
          ref={tickerRef}
          className={`block whitespace-nowrap text-[11px] font-medium ticker-text animate-ticker leading-none ${
