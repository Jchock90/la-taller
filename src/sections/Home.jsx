    ...
    <section id="home" className="relative">
          ...
          <div className="relative rounded-lg overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-full flex justify-center pb-6">
              <motion.span
                ...
                viewport={{ once: true }}
                className={`px-12 py-3.5 tracking-widest uppercase text-xs border cursor-pointer transition-colors duration-300 win-btn ${isDark ? 'border-neutral-700 text-neutral-700 hover:bg-black/10' : 'border-neutral-700 text-neutral-700 hover:bg-black/10'}`}
                onClick={() => setCurrentSection && setCurrentSection('que-vendo')}
              >
                {seeCollectionText} →
              </motion.span>
      ...
      <div className={`w-full ${isDark ? 'bg-black' : 'bg-white'} py-20`}>
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <button
              className={`px-12 py-3.5 tracking-widest uppercase text-xs border cursor-pointer win-btn ${isDark ? 'border-neutral-600 text-neutral-300 hover:bg-neutral-800' : 'border-neutral-300 text-neutral-700 hover:bg-neutral-100'} transition-colors duration-300`}
